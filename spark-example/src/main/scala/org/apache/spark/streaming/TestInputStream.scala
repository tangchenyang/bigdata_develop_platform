...
/**
 * This is a input stream just for the testsuites. This is equivalent to a checkpointable, replayable, reliable
 * message queue like Kafka. It requires a sequence as input, and returns the i_th element at the i_th batch under
 * manual clock.
 */
