...
class OdsStockDaily(Job):
    name = "ods_stock_daily"

    inputs = []
    output = tables.ods_stock_daily
    ...
    def process(self):
        ...
        for stock_code in stock_codes:
            ...
            dataframe_writer.write_to_table(spark_df, self.output, partition_columns=["stock_code"])
